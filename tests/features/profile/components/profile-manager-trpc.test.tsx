...
import { ProfileManager } from '@/features/profile/components/profile-manager-trpc';
...
vi.mock('@/features/profile/hooks/use-profile-queries-trpc', () => ({
  useProfile: vi.fn(),
}));
...
describe('ProfileManager', () => {
  ...
  it('アバターのアップロードを処理する', async () => {
    ...
    const mockConvertFileToBase64 = vi.fn().mockResolvedValue('dammy-base64-data');
    ...
    // convertFileToBase64をモックして 'dammy-base64-data'を返す
    (convertFileToBase64 as ReturnType<typeof vi.fn>).mockImplementation(mockConvertFileToBase64);
    ...
    await waitFor(() => {
      expect(mockUploadAvatar).toHaveBeenCalledWith('dammy-base64-data', 'test-user-id', 'jpg', 'test-profile-avatar.jpg');
    });
  });
