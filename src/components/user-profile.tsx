			...
			<div className="w-96 flex flex-col gap-2">
				...
				<ResponsiveDialog
					...
					<div className="flex flex-col gap-4">
						...
						<DialogFooter>
							<Button type="button" onClick={handleEmailChangeSubmit}>送信</Button>
						</DialogFooter>
					</div>
				</ResponsiveDialog>
				...
				<ResponsiveDialog
					...
					className="flex justify-center">
					<div className="flex flex-col gap-4">
						<Input id="email" onChange={handleEmail} value={email} placeholder="登録しているアドレスを入力してください" />
						<DialogFooter>
							<Button type="button" onClick={handlePasswordChangeMailSubmit}>送信</Button>
						</DialogFooter>
					</div>
				</ResponsiveDialog>
				<div className="text-center">
					<Button className="bg-red-700 hover:bg-red-800" type="button" onClick={handleDeleteUserAccountSubmit}>アカウント削除</Button>
				</div>
			</div>
		</div>
	);
